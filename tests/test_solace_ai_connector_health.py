...
class TestSolaceAiConnectorHealth:
    @patch('solace_ai_connector.solace_ai_connector.ManagementHttpServer')
    @patch('solace_ai_connector.solace_ai_connector.HealthChecker')
    def test_health_check_disabled_by_default(self, mock_health_checker_class, mock_management_server_class):
        ...
        with patch('solace_ai_connector.solace_ai_connector.setup_log'), \
            ...
            assert sac.management_server is None
            mock_health_checker_class.assert_not_called()
            mock_management_server_class.assert_not_called()


    @patch('solace_ai_connector.solace_ai_connector.ManagementHttpServer')
    @patch('solace_ai_connector.solace_ai_connector.HealthChecker')
    def test_health_check_enabled_in_config(self, mock_health_checker_class, mock_management_server_class):
        """Test health check is started when enabled in config"""
        mock_health_checker = Mock()
        mock_management_server = Mock()
        mock_health_checker_class.return_value = mock_health_checker
        mock_management_server_class.return_value = mock_management_server
        ...
        with patch('solace_ai_connector.solace_ai_connector.setup_log'), \
            ...
            mock_management_server.start.assert_called_once()


    @patch('solace_ai_connector.solace_ai_connector.ManagementHttpServer')
    @patch('solace_ai_connector.solace_ai_connector.HealthChecker')
    def test_health_checker_marked_ready_after_create_apps(self, mock_health_checker_class, mock_management_server_class):
    ...
    @patch('solace_ai_connector.solace_ai_connector.ManagementHttpServer')
    @patch('solace_ai_connector.solace_ai_connector.HealthChecker')
    def test_health_check_stopped_on_connector_stop(self, mock_health_checker_class, mock_management_server_class):
        ...
        with patch('solace_ai_connector.solace_ai_connector.setup_log'), \
            ...
            mock_management_server.stop.assert_called_once()
